export default {
  ...
  'menu.salary.allowance': '津贴录入',
  'menu.salary.salary': '薪资发放',
  'menu.salary.salary-setting': '薪资配置',
  'menu.performance': '绩效管理',
  'menu.performance.performance': '绩效评价',
  'menu.performance.performance-setting': '绩效设置',
  'menu.attendance': '考勤管理',
  'menu.attendance.attendance-month': '月度考勤',
  'menu.attendance.attendance-quarter': '季度考勤',
  'menu.recruit': '招聘业务',
