...
(
    ...
    `registered_client_id`     varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL UNIQUE COMMENT 'oauth2客户端id',
...
-- oauth2客户端认证方式表
-- ----------------------------
DROP TABLE IF EXISTS `oauth2_client_auth_method`;
CREATE TABLE `oauth2_client_auth_method`
(
    `registered_client_id`         varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'oauth2客户端id',
    `client_authentication_method` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '客户端认证方式',
    PRIMARY KEY (`registered_client_id`, `client_authentication_method`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    PRIMARY KEY (`registered_client_id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    PRIMARY KEY (`registered_client_id`, `grant_type_name`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    PRIMARY KEY (`registered_client_id`, `redirect_uri`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    `registered_client_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'oauth2客户端id',
    `scope`                varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '客户端允许的scope 来自role表',
    `description`          varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
    PRIMARY KEY (`registered_client_id`, `scope`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
